# Insta_Osint
     ...
     Gather publicly available information from 
     Instagram profiles to analyze connections 
     activities  and trends  Useful
     for cybersecurity research investigations 
